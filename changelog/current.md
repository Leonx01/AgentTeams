...
- **CoPaw Manager Worker allowlist reload**: Keep the OpenClaw-to-CoPaw config watcher alive across transient bridge failures and apply new Worker Matrix allowlist entries promptly. ([6e1466d](https://github.com/agentscope-ai/AgentTeams/commit/6e1466d))
